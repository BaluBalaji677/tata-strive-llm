...
const LessonViewerPage = ({ lessonId, prevLesson, nextLesson, onNavigate, isCompleted, onLessonCompleted }) => {
      ...
      <div className="mt-12 pt-6 border-t border-white/10 flex items-center justify-between pb-8">
        ...
        {nextLesson && (
          <button
            ...
            className="flex items-center px-4 py-2 text-sm font-medium text-white bg-indigo-500/80 border border-indigo-500/30 rounded-lg hover:bg-indigo-500 transition-colors shadow-sm"
          >
